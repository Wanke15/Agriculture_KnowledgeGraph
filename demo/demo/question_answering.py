    ...
    for i in selected_index:
        ...
        if (selected_plant[-1] == "科"):
            ...
            if (ret_dict.get('list') is None):
                ret_dict['list'] = []
            ret_dict['list'].append({"entity1": weather, "rel": "适合种植", "entity2": selected_plant, "entity1_type": "气候",
                                     "entity2_type": "植物"})
            for j in selected_concrete_index:
                ...
                ret_dict['list'].append(
                    {"entity1": concrete_plant, "rel": "科", "entity2": selected_plant, "entity1_type": "植物科",
                     "entity2_type": "植物"})
    ...
    if (address in city_list):
        ...
        if (weather != 0):
            if (ret_dict.get('list') is None):
                ret_dict['list'] = []
            ret_dict['list'].append(
                {'entity1': address, 'rel': '气候', 'entity2': weather, 'entity1_type': '地点', 'entity2_type': '气候'})
        ...
        if (address_chinese_name in city_list):
            ...
            if (weather != 0):
                if (ret_dict.get('list') is None):
                    ret_dict['list'] = []
                ret_dict['list'].append(
                    {'entity1': address_chinese_name, 'rel': '气候', 'entity2': weather, 'entity1_type': '地点',
                     'entity2_type': '气候'})
...
def get_nutrition(obj, ret_dict):
    ...
    if (len(nutrition) > 0):
        ...
        for index in selected_index:
            ...
            if (ret_dict.get('list') is None):
                ret_dict['list'] = [
                    {'entity1': obj, 'rel': '含有', 'entity2': x, 'entity1_type': '主语', 'entity2_type': '元素'}]
            else:
                ret_dict['list'].append(
                    {'entity1': obj, 'rel': '含有', 'entity2': x, 'entity1_type': '主语', 'entity2_type': '元素'})
...
def get_plant_knowledge(obj, ret_dict):
    ...
    if (len(ke) > 0):
        if (ret_dict.get('list') is None):
            ret_dict['list'] = [{'entity1': obj, 'rel': '科', 'entity2': ke[0]['n2']['title'], 'entity1_type': '植物',
                                 'entity2_type': '类型'}]
        else:
            ret_dict['list'].append({'entity1': obj, 'rel': '科', 'entity2': ke[0]['n2']['title'], 'entity1_type': '植物',
                                     'entity2_type': '类型'})
        if (ret_dict.get('answer') is None):
    ...
    if (len(shu) > 0):
        if (ret_dict.get('list') is None):
            ret_dict['list'] = [{'entity1': obj, 'rel': '属', 'entity2': shu[0]['n2']['title'], 'entity1_type': '植物',
                                 'entity2_type': '类型'}]
        else:
            ret_dict['list'].append({'entity1': obj, 'rel': '属', 'entity2': shu[0]['n2']['title'], 'entity1_type': '植物',
                                     'entity2_type': '类型'})
        if (ret_dict.get('answer') is None):
    ...
    if (len(gang) > 0):
        if (ret_dict.get('list') is None):
            ...
            ret_dict['list'].append(
                {'entity1': obj, 'rel': '纲', 'entity2': gang[0]['n2']['title'], 'entity1_type': '植物',
                 'entity2_type': '类型'})
        if (ret_dict.get('answer') is None):
    ...
    if (len(yamu) > 0):
        if (ret_dict.get('list') is None):
            ...
            ret_dict['list'].append(
                {'entity1': obj, 'rel': '亚目', 'entity2': yamu[0]['n2']['title'], 'entity1_type': '植物',
                 'entity2_type': '类型'})
        if (ret_dict.get('answer') is None):
            ...
            for address in address_name:
                ...
                if (flag == 1):
                    ...
                    if (len(shoudu) > 0):
                        ...
                        if (ret_dict.get('list') is None):
                            ret_dict['list'] = [
                                {'entity1': address, 'rel': '首都', 'entity2': shoudu, 'entity1_type': '地点',
                                 'entity2_type': '地点'}]
                            address = shoudu
                address = address.strip()
                print(address)
